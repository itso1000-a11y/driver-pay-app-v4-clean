...
function downloadDriverBackup(days: DayRecord[], settings: SettingsState, payslipActualWeek: string, archive: any[]) {
  ...
  link.href = url;
  link.download = `driver-pay-backup-${activeWeekSaturdayISO}-${new Date().toLocaleDateString("en-GB").replace(/\//g,"-")}.json`;
