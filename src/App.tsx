...
function getRestFromPreviousShiftMinutes(anchor: PreviousShiftAnchor | null, current: DayRecord): number | null {
  ...
  // Bridge rest calculation across pay-week boundaries.
  // Keep the compact v4.37.21 UI untouched; only prevent rest/start suggestions
  // from disappearing when the previous completed shift is in the previous week.
